...
export function ObjectIcon({ obj }: { obj: string }) {
  const icons: Record<string, JSX.Element> = {
    ...
    cama: (
      /* Banco — se mece de lado a lado */
      <svg viewBox="0 0 24 24" fill="none" width="100%" height="100%" className={styles.animBancoMece}>
        ...
        <rect x="2" y="10.5" width="20" height="3.5" rx="1.5" fill="#d97706" stroke="#92400e" strokeWidth="1.2"/>
    ...
    mesa: (
      /* Extintor — cuerpo presuriza + pitorro tiembla */
      <svg viewBox="0 0 24 24" fill="none" width="100%" height="100%">
        <g className={styles.animExtintorBody}>
    ...
    tv: (
      ...
      <svg viewBox="0 0 24 24" fill="none" width="100%" height="100%">
        ...
        {/* destello dorado que sube */}
        <rect x="8.5" y="6" width="7" height="2.5" rx="0.5" fill="#fde68a" fillOpacity="0.6" className={styles.animColumnaLuz}/>
    ...
    estanteria: (
      /* Estatua — brazo izquierdo sube y baja */
      <svg viewBox="0 0 24 24" fill="none" width="100%" height="100%" overflow="visible">
        ...
        <rect x="9.5" y="8" width="5" height="7" rx="1.5" fill="#78350f" stroke="#3d1a00" strokeWidth="1"/>
        <ellipse cx="12" cy="5.5" rx="2.5" ry="3" fill="#78350f" stroke="#3d1a00" strokeWidth="0.9"/>
        {/* brazo izquierdo animado — gira desde el hombro (9.5, 10) */}
        <line x1="9.5" y1="10" x2="5" y2="13" stroke="#78350f" strokeWidth="1.6" strokeLinecap="round" className={styles.animEstatuaBrazo}/>
        {/* brazo derecho estático */}
        <line x1="14.5" y1="9.5" x2="19" y2="7" stroke="#78350f" strokeWidth="1.6" strokeLinecap="round"/>
      </svg>
    ),
    caja: (
      /* Papelera — tapa se abre y cierra ("come") desde bisagra derecha */
      <svg viewBox="0 0 24 24" fill="none" width="100%" height="100%">
        {/* tapa + mango animados juntos */}
        <rect x="9.5" y="1.5" width="5" height="3.5" rx="1.5" fill="#78350f" stroke="#3d1a00" strokeWidth="1" className={styles.animPapeleraCome}/>
        <rect x="3.5" y="4.5" width="17" height="3" rx="1" fill="#92400e" stroke="#3d1a00" strokeWidth="1" className={styles.animPapeleraCome}/>
        {/* cuerpo estático */}
